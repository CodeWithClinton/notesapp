...
const App = () => {
  ...
  const filteredNotes =
    filterText === "BUSINESS"
      ...
      useEffect(() => {
        ...
        axios.get(`https://notesbackend-tqf5.onrender.com/notes-search/?search=${searchText}`)
        .then(res => {
  ...
  useEffect(() => {
    setIsLoading(true);
    axios
      .get("https://notesbackend-tqf5.onrender.com/notes/")
      .then((res) => {
        // console.log(res.data);
        setNotes(res.data);
        setIsLoading(false);
  ...
  const addNote = (data) => {
    axios
      .post("https://notesbackend-tqf5.onrender.com/notes/", data)
      .then((res) => {
        setNotes([...notes, data]);
  ...
  const updateNote = (data, slug) => {
    axios
      .put(`https://notesbackend-tqf5.onrender.com/notes/${slug}/`, data)
      .then((res) => {
        console.log(res.data);
  ...
  const deleteNote = (slug) => {
    axios
      .delete(`https://notesbackend-tqf5.onrender.com/notes/${slug}`)
      .catch((err) => console.log(err.message));
  };
